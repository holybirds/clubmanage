    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray">
        ...
        <td align="center" valign="middle" class="borderbottom">
            <a href="${pageContext.request.contextPath}/JoinUpdateOneActivityById?activityid=${act.activityId}" target="mainFrame" onFocus="this.blur()" class="add" onclick="return confirm('确定修改吗？')">修改</a></span>
        </td>
      </tr>
      </c:forEach>
...
<%--            <form method="post" action="SelectActivityByUsername">--%>
