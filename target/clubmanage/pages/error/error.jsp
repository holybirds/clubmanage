...
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style>
        ...
        .main{width: 700px;overflow: hidden;height: 542px;margin: 20px auto;background: url(${pageContext.request.contextPath}/static/images/user_images/error-bg.png) no-repeat 0 0;}
        .title{font-size: 14px;font-weight: bold;margin: 254px 0 0 218px;color: #d3d3d3;}
        .btn{
	        display:block;
	        background: url(${pageContext.request.contextPath}/static/images/user_images/error-btn.png) no-repeat 0 0;
	        width: 145px;
	        height: 45px;
	        font-size: 14px;
