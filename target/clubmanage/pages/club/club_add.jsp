...
#addinfo a:hover{ background:url(${pageContext.request.contextPath}/static/images/admin_image/main/addinfoblue.jpg) no-repeat 0 1px;}
  ...
  <script>
    $(function (){
      $.getJSON("${pageContext.request.contextPath}/SelectClubCreatByusername",function (date1){
        if (date1!=null){
          if (date1.clubCreatstate==0){
            $("span.errorMsg").text("社团创建已拒绝，请重新创建");
          }else if (date1.clubCreatstate==1){
            $("span.errorMsg").text("社团创建正在等待审核，请勿重复创建");
      ...
      $("#clubname").blur(function () {
        ...
        $.getJSON("${pageContext.request.contextPath}/ClubCreatNameIs?clubname=" + clubname,function (data) {
          if (1 == data) {
            $("span.errorMsg").text("社团名已存在！");
            document.getElementById('clubname').focus();
          } else if (2 == data){
            $("span.errorMsg").text("社团名可用！");
          }
        });
      });
    })
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：社团加入管理&nbsp;&nbsp;>&nbsp;&nbsp;社团创建</td>
  </tr>

  <tr>
    <td align="left" valign="top" id="addinfo">
      <c:if test="${requestScope.msg =='success' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>头像上传成功且</b></font></c:if>
      <c:if test="${requestScope.msg =='fail' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>头像上传失败且</b></font></c:if>
  ...
  <tr>
    ...
    <form method="post" action="${pageContext.request.contextPath}/UserClubCreat"enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">社团头像：</td>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input id="clubname" type="text" name="clubName" value="" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="clubTenet" value="" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">社团介绍：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <textarea rows="5" cols="45" style="resize: none" name="clubIntroduction"  class="text-word"></textarea>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">&nbsp;</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input id="btn" name="" type="submit" value="提交" class="text-but">
