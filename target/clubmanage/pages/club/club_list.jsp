...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：社团及活动管理&nbsp;&nbsp;>&nbsp;&nbsp;社团列表</td>
  </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="SelectOneClub">
	         <span>社团：</span>
...
<%--  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="community_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">添加社团</a></td>--%>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom">
            <a href="${pageContext.request.contextPath}/JoinUpdateClubOne?clubid=${club.clubId }" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
            <a href="${pageContext.request.contextPath}/DeleteClubOne?clubname=${club.clubName }&startnum=1" target="mainFrame" onFocus="this.blur()" class="add"onclick="return confirm('确定删除吗？')">删除</a></td>
      </tr>
      </c:forEach>
  ...
  <tr>
      <td align="left" valign="top" class="fenye">共有${clubpage.total} 条记录，当前第${clubpage.pageNum}页
          &nbsp; &nbsp; &nbsp;
          <a href="QueryAllClub?startnum=1">首页</a>
          <c:if test="${clubpage.pageNum>1}" ><a href="QueryAllClub?startnum=${clubpage.prePage}">上一页</a></c:if>
          <c:if test="${clubpage.pageNum==1}" ><a href="QueryAllClub?startnum=1">上一页</a></c:if>
          <c:if test="${clubpage.pageNum<clubpage.pages}" ><a href="QueryAllClub?startnum=${clubpage.nextPage}">下一页</a></c:if>
          <c:if test="${clubpage.pageNum==clubpage.pages}" ><a href="QueryAllClub?startnum=${clubpage.pages}">下一页</a></c:if>
          <a href="QueryAllClub?startnum=${clubpage.pages}">尾页</a>
    ...
    <tr>   <td><div align="center" style="color: #8A0B00">${requestScope.msg}</div></td></tr>
      ...
      <td width="90%" style="color: #8A0B00" align="center" valign="middle">
          <form method="post" action="QueryAllClub?startnum=1">
