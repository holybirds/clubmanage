...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：社团及活动管理&nbsp;&nbsp;>&nbsp;&nbsp;活动列表</td>
  </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="SelectOneActivity">
	         <span>活动：</span>
 ...
 <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray">
        ...
        <td align="center" valign="middle" class="borderbottom">
            <a href="${pageContext.request.contextPath}/JoinUpdateOneActivity?activityname=${act.activityName}" target="mainFrame" onFocus="this.blur()" class="add" onclick="return confirm('确定修改吗？')">修改</a><span class="gray">&nbsp;|&nbsp;</span></span>
            <a href="${pageContext.request.contextPath}/DeleteActivityOne?activityname=${act.activityName}&startnum=1"  target="mainFrame" onFocus="this.blur()" class="add" onclick="return confirm('确定删除吗？')">删除</a></td>
      </tr>
      </c:forEach>
    ...
    <tr>
        <td align="left" valign="top" class="fenye">共有${activitypage.total} 条记录，当前第${activitypage.pageNum}页
            &nbsp; &nbsp; &nbsp;
            <a href="QueryAllActivity?startnum=1">首页</a>
            <c:if test="${activitypage.pageNum>1}" ><a href="QueryAllActivity?startnum=${activitypage.prePage}">上一页</a></c:if>
            <c:if test="${activitypage.pageNum==1}" ><a href="QueryAllActivity?startnum=1">上一页</a></c:if>
            <c:if test="${activitypage.pageNum<activitypage.pages}" ><a href="QueryAllActivity?startnum=${activitypage.nextPage}">下一页</a></c:if>
            <c:if test="${activitypage.pageNum==activitypage.pages}" ><a href="QueryAllActivity?startnum=${activitypage.pages}">下一页</a></c:if>
            <a href="QueryAllActivity?startnum=${activitypage.pages}">尾页</a><br>
        </td>
    </tr>
    </c:if>
    ...
    <c:if test="${requestScope.msg1=='activity'}">
        <td width="90%" style="color: #8A0B00" align="center" valign="middle">
            <form method="post" action="QueryAllActivity?startnum=1">
