...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：用户管理&nbsp;&nbsp;>&nbsp;&nbsp;用户信息修改</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a  href="SelectOneUser?username=${requestScope.user1.getUserName()}" target="mainFrame"  class="">返回管理员界面</a><div style="color: #8A0B00">${requestScope.errormessage}
...
<%--         <c:if test="${param.rs =='namewrong' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>没有此用户，请先添加</b></font></c:if>
 ...
 --%>    
  ...
  <tr>
    ...
    <form action="UpdateUserOne" method="post" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr style="height:80px;">
        <td align="center" valign="middle" class="borderright borderbottom bggray">
          <img src="${pageContext.request.contextPath}${requestScope.user1.getUserImagepath()}" width="60px" height="60px" style="border-radius: 50%;">
        </td>
      ...
      <tr>
        ...
        <input id="name" type="text" name="userName" value="${requestScope.user1.getUserName() }" class="text-word">
        </td>
        <td align="right" valign="middle" class="borderright borderbottom bggray">学号：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input id="stuid" type="text" name="studentId" value="${requestScope.user1.studentId }" class="text-word">
        </td>
      </tr>
        <tr>
        <td align="right" valign="middle" class="borderright borderbottom bggray">性别：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <input type="text" name="sex" value="${requestScope.user1.sex}" class="text-word">


        <td align="right" valign="middle" class="borderright borderbottom bggray">年级：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <input type="text" name="grade" value="${requestScope.user1.grade }" class="text-word">
        </tr>
      <tr>
        <td align="right" valign="middle" class="borderright borderbottom bggray">学院：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <input type="text" name="college" value="${requestScope.user1.college }" class="text-word">
        </td>

        <td align="right" valign="middle" class="borderright borderbottom bggray">邮箱：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <input type="text" name="email" value="${requestScope.user1.email }" class="text-word">
      </tr>
      <tr>
        <td align="right" valign="middle" class="borderright borderbottom bggray">联系方式：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <input type="text" name="phone" value="${requestScope.user1.phone }" class="text-word">
        </td>
...
<%--        <input type="text" name="jcom" value="${user.joinedClub }" class="text-word">--%>
          <div>${requestScope.user1.joinedClub }</div>
        </td>
        </tr>
