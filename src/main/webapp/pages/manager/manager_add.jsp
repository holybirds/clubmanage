...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a  target="mainFrame"  class="">新增管理员</a>
    <c:if test="${requestScope.rs =='success' }"><font -size="4px"; color=blue>&nbsp;&nbsp;&nbsp;<b>修改成功</b></font></c:if>
    <c:if test="${requestScope.rs =='fail' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>修改失败，请重新尝试</b></font></c:if>
  ...
  <tr>
    ...
    <form method="post" action="${pageContext.request.contextPath}/ManagerAdd">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户名：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input id="name" type="text" name="userName" value="" class="text-word">
        </td>
        </tr>
