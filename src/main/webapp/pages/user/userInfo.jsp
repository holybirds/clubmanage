    ...
    <script>
        $(function (){
            $("#copyemail").click(function () {
                ...
                input.setAttribute('value', emailstring);
                input.select();
                if (document.execCommand('copy')) {
                    document.execCommand('copy');
                    alert("邮箱复制成功，在发邮件页面直接粘贴即可给对方发邮件")
                }
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：用户界面&nbsp;&nbsp;>&nbsp;&nbsp;用户信息</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a target="_blank" href="${pageContext.request.contextPath}/joinIndex"   class="">返回首页</a><div style="color: #8A0B00">${requestScope.errormessage}
...
<%--          <input id="stuid" type="text" name="studentId" value="${sessionScope.user.studentId }" class="text-word">--%>
      ...
      <tr>
        ...
        <td id="email" align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ${userinfo.email }
      </tr>
      <tr>
      ...
      <tr>
        <td align="center" valign="middle" class="borderright borderbottom main-for" colspan="2" style="padding-left:38%; border-right:none;">
            <a id="copyemail" href="https://mail.qq.com/" target="_blank" >给他发邮件</a>
        </td>
