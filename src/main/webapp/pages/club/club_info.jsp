...
<!-- css files -->
<link href="${pageContext.request.contextPath}/static/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all" />
<link href="${pageContext.request.contextPath}/static/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all" />
<link href="${pageContext.request.contextPath}/static/css/chromagallery.css" rel="stylesheet" type="text/css" media="all" />
<link href="${pageContext.request.contextPath}/static/css/info.css" rel="stylesheet" type="text/css"   />
<!-- /css files -->
<!-- fonts -->
				...
				<div class="about-details">
					<div class="row">
						<div class="col-sm-2 col-xs-12">
							<img src="${pageContext.request.contextPath}/static/images/header/head.jpg" class="img-responsive slideanim" alt="about-img">
						</div>
...
<script src="${pageContext.request.contextPath}/static/js/SmoothScroll.min.js"></script>
<!-- js files for gallery -->
<script src="${pageContext.request.contextPath}/static/js/chromagallery.pkgd.min.js"></script>
