...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：投票管理&nbsp;&nbsp;>&nbsp;&nbsp;投票修改</td>
  </tr>
<%--  <tr>--%>
...
<%--	         </form>--%>
<%--         </td>--%>
<%--&lt;%&ndash;  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="${pageContext.request.contextPath}/pages/user/regist.jsp" target="mainFrame" onFocus="this.blur()" class="add">新增成员</a></td>&ndash;%&gt;--%>
<%--  		</tr>--%>
<%--	</table>--%>
<%--    </td>--%>
<%--  </tr>--%>
        ...
        <td align="center" valign="middle" class="borderbottom">
            <c:choose>
                <c:when test="${vote.voteCreatstate == 1 }">
                    <a href="UserDeleteOneVote?voteid=${vote.voteId}"  target="mainFrame" onFocus="this.blur()" class="add" onclick="return confirm('确定取消吗？')">取消发布</a>
                </c:when>
  ...
  <tr>
    ...
    <tr>   <td><div align="center" style="color: #8A0B00">${requestScope.msg}</div></td></tr>
      ...
      <td width="90%" style="color: #8A0B00" align="center" valign="middle">
          <form method="post" action="${pageContext.request.contextPath}/UserSelectOneVote?username=${sessionScope.user.userName}">
