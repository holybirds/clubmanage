...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：社团活动&nbsp;&nbsp;>&nbsp;&nbsp;已参与活动</td>
  </tr>
      ...
      <tr class="bggray">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${act.activityContent }</td>
                  <td align="center" valign="middle" class="borderbottom">
                      <a  href="${pageContext.request.contextPath}/JoinUserInfoByClubName?clubname=${act.club}"  onFocus="this.blur()" class="add">给活动管理员发邮件</a>
                  </td>
      </tr>
      </c:forEach>
